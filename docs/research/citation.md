...
@inproceedings{climatextract2024,
  ...
  author    = {LMU SODA Lab},
  booktitle = {Proceedings of the ClimateNLP Workshop at ACL 2024},
  year      = {2024},
...
**GitHub:** [https://github.com/gist-sustainability/climatextract](https://github.com/gist-sustainability/climatextract)

---

## License

climatextract is released under an open-source license. See the `LICENSE` file in the repository for details.
...
- **LMU SODA Lab:** [https://www.soda.statistik.uni-muenchen.de/](https://www.soda.statistik.uni-muenchen.de/)
- **GitHub Issues:** [https://github.com/gist-sustainability/climatextract/issues](https://github.com/gist-sustainability/climatextract/issues)
